...
/* Insertion of Student's table data */
...
/*Insertion of Faculty's table data */
...
/* Insertion of Class's table data */
 insert into Class 
...
/* Insertion of Enrolled's table data */
...
/* 2nd */
select distinct Faculty.fid,Faculty.fname,Faculty.deptid from Faculty join Class
where Class.room = "R15" and Class.fid = Faculty.fid;

/* 3rd */
select Faculty.fname from Faculty join Enrolled join Class
where cname  = "Orbital Mechanics";

/* 4th */
select sname from Student join Faculty 
where Faculty.fname = "John Williams";

/* 5th */
select sname from Student join Faculty 
where level = "SR" and Faculty.fname = "Ivana Teach";

/* 6th */
select major from Student
where sname = "Lisa Walker";
...
/* 8th */
select cname from Enrolled,Student
where Student.sname = "Lisa Walker" and Student.snum = Enrolled.snum;


/* 9th */
select distinct sname  from Student, Enrolled
